          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('register') }}" novalidate>
              ...
              <div class="mb-3">
                ...
                <x-input-error :messages="$errors->get('name')" class="mt text-danger lead" />
              </div>
              <div class="mb-3">
                <label class="form-label">Email address</label>
                <input type="email" name="email" :value="old('email')" required class="form-control" placeholder="your@email.com" autocomplete="off">
                <x-input-error :messages="$errors->get('email')" class="mt text-danger lead" />
              </div>
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  ...
                  <x-input-error :messages="$errors->get('password')" class="mt text-danger lead" />
                </div>
              </div>
              <div class="mb-2">
                <label class="form-label">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" name="password_confirmation" required class="form-control"  placeholder="Confirm password"  autocomplete="off">
                  <x-input-error :messages="$errors->get('password_confirmation')" class="mt text-danger lead" />
                  <span class="input-group-text">
                    <a href="#" class="link-secondary" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" /></svg>
                    </a>
