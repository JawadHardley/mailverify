...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } #u_content_text_3 a { color: #f1c40f; } @media (max-width: 480px) { #u_content_image_3 .v-container-padding-padding { padding: 25px 10px 0px !important; } #u_content_image_3 .v-src-width { width: auto !important; } #u_content_image_3 .v-src-max-width { max-width: 35% !important; } #u_content_image_3 .v-text-align { text-align: left !important; } #u_content_heading_5 .v-font-size { font-size: 14px !important; } #u_content_heading_6 .v-font-size { font-size: 35px !important; } #u_content_heading_6 .v-line-height { line-height: 120% !important; } #u_content_text_5 .v-container-padding-padding { padding: 80px 15px 10px 10px !important; } #u_content_heading_3 .v-container-padding-padding { padding: 30px 10px 10px !important; } #u_content_heading_3 .v-font-size { font-size: 22px !important; } #u_content_heading_3 .v-line-height { line-height: 120% !important; } #u_content_divider_1 .v-container-padding-padding { padding: 0px 10px 10px !important; } #u_content_text_2 .v-container-padding-padding { padding: 10px !important; } #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 100% !important; } #u_content_heading_4 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_heading_4 .v-text-align { text-align: center !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 10px 0px !important; } #u_content_text_3 .v-text-align { text-align: center !important; } #u_content_social_1 .v-container-padding-padding { padding: 30px 0px 20px 75px !important; } #u_content_text_4 .v-container-padding-padding { padding: 20px 0px 10px !important; } #u_content_text_4 .v-font-size { font-size: 13px !important; } #u_content_text_4 .v-text-align { text-align: center !important; } #u_content_image_2 .v-container-padding-padding { padding: 10px 0px 20px !important; } #u_content_image_2 .v-src-width { width: auto !important; } #u_content_image_2 .v-src-max-width { max-width: 51% !important; } #u_content_image_2 .v-text-align { text-align: center !important; } }
    </style>



<!--[if !mso]><!--><link href="https://fonts.googleapis.com/css2?family=Arvo&display=swap" rel="stylesheet" type="text/css"><link href="https://fonts.googleapis.com/css?family=Raleway:400,700&display=swap" rel="stylesheet" type="text/css"><!--<![endif]-->
...
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  ...
  <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 10px solid #ffffff;border-left: 10px solid #ffffff;border-right: 10px solid #ffffff;border-bottom: 0px solid transparent;"><!--<![endif]-->
...
<table id="u_content_image_3" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:25px 20px 15px 10px;font-family:arial,helvetica,sans-serif;" align="left">
...
<div class="u-col u-col-66p67" style="max-width: 320px;min-width: 400px;display: table-cell;vertical-align: top;">
  <div style="background-color: #e6eaf2;height: 100%;width: 100% !important;">
  <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 10px solid #ffffff;border-right: 0px solid transparent;border-bottom: 10px solid #ffffff;"><!--<![endif]-->
...
<table id="u_content_heading_5" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #5c5c5c; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;"><span><span><span><span><span><span><span><span><span>Sorry to</span></span></span></span></span></span></span></span></span></h1>
...
<table id="u_content_heading_6" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #007aff; line-height: 120%; text-align: left; word-wrap: break-word; font-family: Arvo; font-size: 61px; font-weight: 400;"><span style="line-height: 42px;"><span style="line-height: 42px;"><span style="line-height: 42px;"><span style="line-height: 42px;"><strong><span style="line-height: 42px;"><span style="line-height: 42px;"><span style="line-height: 42px;">See You Go !</span></span></span></strong></span></span></span></span></h1>
  <!--[if mso]></td></tr></table><![endif]-->
...
This is to confirm that your account with [Your Company Name] has been successfully deleted, as per your request. We are sorry to see you go, but we respect your decision and want to thank you for being a part of our community.
    </p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;">Please know that we are here for you if you ever decide to return or need any assistance in the future. If there’s anything we can do to improve our services, we would greatly appreciate your feedback.</p>
<p style="line-height: 140%;"> </p>
<p style="line-height: 140%;">Thank you once again for choosing [Your Company Name]. We wish you all the best in your future endeavors.
